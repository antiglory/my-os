; -> bootloader loada prekernel | OK
; -> prekernel entra no modo protegido
; -> prekernel inicializa a GDT e a IDT
; -> prekernel carrega o kernel na memoria em endereços altos pq ta no modo protegido (vc vai precisar criar a propria funcao pra mandar informacoes pro disco, como se fosse um pequeno driver, pq n tem mais BIOS interrupt)
...
; -> ai jumpa pro kernel e a partir de lá, em C, vc consegue criar uma paginação completa pro kernel e posteriormente PML4 de cada processo q vai ser criado
